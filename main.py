...
# 2. Validar o tempo nencessário para a consulta e limitação da api pública.
...
class Main():
    ...
    def run(self):
        ...
        conteudo = ""\
            "Olá, dado o inicio da geraçãoo do arquivo cnpj.\n"\
        ...
        self.log.info("Iniciando Validaçãoo e busca dos cnpj's")
        ...
        try:
            ...
            self.evnia_email(conteudo, destinatarios, titulo="Finalizaçãoo Endereços", file_path=os.path.join(cnpj_path, "cnpj.csv"))
            ...
            self.log.error("Ocorreu um erro na realizaçãoo das consultas.")
